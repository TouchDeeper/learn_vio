...
//////////////// OUR SOLVER //////////////////
    ...
    IntegrationBase *pre_integrations[(WINDOW_SIZE + 1)]; //数组中的每个元素都是指向IntegrationBase类型的指针
    ...
    double para_SpeedBias[WINDOW_SIZE + 1][SIZE_SPEEDBIAS];//就是speed + bias
